    ...
    return (
        <>
            <div className='container text-center my-5'>
                ...
                <button type='submit' onClick={changePhoto} className='btn btn-danger my-2'>Get Photo</button>
            </div>
                    ...
                    {result.map((value) => {
                        return (
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6" >
                                    <img class="img-fluid img-thumbnail w-100 shadow-1-strong mb-4" src={value.urls.small} alt='' />
                            </div>
                        )
                    })}
                </div>
